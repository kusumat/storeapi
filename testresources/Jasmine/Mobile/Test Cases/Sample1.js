it("Sample1", async function() {
	...
	voltmx.automation.widget.touch(["frmProductDescription","MobileHeader","imgMenuPrevious"], null,null,[8,17]);
	await voltmx.automation.playback.wait(1000);
	await voltmx.automation.playback.waitFor(["frmProductDetails","MobileHeader","imgMenuPrevious"]);
	voltmx.automation.widget.touch(["frmProductDetails","MobileHeader","imgMenuPrevious"], null,null,[3,14]);
	await voltmx.automation.playback.wait(1000);
	await voltmx.automation.playback.waitFor(["frmCreateOrder","MobileHeader","imgMenuPrevious"]);
	voltmx.automation.widget.touch(["frmCreateOrder","MobileHeader","imgMenuPrevious"], null,null,[10,14]);
});