define({ 
  ...
  onNavigate:function(){
    gblSettings(this);
    var toForm = "frmAppellantDash";
    if(gblIsARUser) {
      toForm = gblARHearingFrom;
    } 
	this.view.preShow = this.preShow;
    this.view.headerCancelRHearing.toHearingRequest(toForm);
    this.view.fContinueButton.navigatingBFormsOnlyContinue(toForm);
