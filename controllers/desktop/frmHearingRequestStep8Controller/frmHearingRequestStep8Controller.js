  ...
  setFinalSummaryValues:function() {
    ...
    if(!Object.entries) {
      programsAndIssues.forEach(function(entry) {
        var program = entry[0];
        var issue = entry[1];
        row = {"lblTextTitleSec":"Benefits Program(s):","lblTextDesc":program,"imgBtnEdit":"edit.png","editPage":"frmHearingRequestStep3"};
        data.push(row);	
        row = {"lblTextTitleSec":"Issue(s):","lblTextDesc":issue,"imgBtnEdit":"", "editPage":"frmHearingRequestStep3"};
        data.push(row);	
        row = {"lblTextTitleSec":"Issue Comments:","lblTextDesc":issueComments,"imgBtnEdit":"", "editPage":"frmHearingRequestStep3"};
        data.push(row);
