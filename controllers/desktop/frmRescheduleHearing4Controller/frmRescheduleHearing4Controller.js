define({ 
  ...
  onNavigate:function(){
    gblSettings(this);
    gblFrmCurrentName = "frmRescheduleHearing4";
    var formCancel = "";
    if (gblIsARUser) {
    ...
    this.view.fContinueBackButton.navigatingBFormsBack("frmRescheduleHearing3");
    this.view.fContinueBackButton.navigatingBFormsContinue("frmRescheduleHearing5");
    ...
    this.view.snDocCauses.btnMissingDocumentsOnClick = this.navigateForward;
  ...
  navigateForward:function(){
    var ntf = new kony.mvc.Navigation("frmRescheduleHearing5");
    ntf.navigate();
  },
