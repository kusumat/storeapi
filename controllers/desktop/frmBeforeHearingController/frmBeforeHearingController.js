define({ 
  ...
  postShow: function() {
    ...
    this.view.navHeaderBar.setCurrentPage('frmBeforeHearing');
    this.view.hamburgerMenu.setCurrentPage('frmBeforeHearing');
  ...
  initPage: function() {
    ...
    this.view.questionsList.collapseQuestions();
  },
  ...
  onBreakpointChange: function(width){
    ...
    // setting headers & footer sizes
      ...
      this.view.twoRowsHearingCategories1.breakPointChange(width);
      this.view.richTextOneRowSMS.breakPointChange(width);
      this.view.richTextOneRow.breakPointChange(width);
      this.view.twoRowsCompileEvidence1.breakPointChange(width);
      this.view.richTextOneRow1.breakPointChange(width);
  ...
  onEnableChat: function() {
    if (gblNavJumpParm ==='{"myAttribute":"SMS"}') {
      this.view.richTextOneRowSMS.setFocus(true);
      gblNavJumpParm = ' ';
    }
