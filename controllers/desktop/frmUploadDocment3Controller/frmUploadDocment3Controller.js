define({ 
  ...
  onNavigate:function(params){
    ...
    this.view.snDocCauses.isVisibleCheckboxAttestation = flowName === "Appeal Summary";
  ...
  navigateForward:function() {    
    if (flowName === "Appeal Summary" && gblAttestationAgree === false){
      alert('Please attest that the Appeal Summary that you have uploaded is true, accurate, and complete only to the appellant associated with this appeal(s).'); 
      return;
    }
