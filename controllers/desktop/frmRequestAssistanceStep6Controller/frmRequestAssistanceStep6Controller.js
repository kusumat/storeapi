define({ 
 ...
 //Type your controller code here 
  ...
  onNavigate:function(){
    ...
    this.view.headerCancelRHearing.toHearingRequest("frmAppealDetails");
    this.view.fContinueButton.navigatingBFormsOnlyContinue("frmAppealDetails");
    ...
    this.view.snThanksYouReschedule.textDesc2 = "";
