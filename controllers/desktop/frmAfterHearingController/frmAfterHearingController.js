define({ 
  ...
  postShow: function() {
    ...
    this.view.navHeaderBar.setCurrentPage('frmAfterHearing');
    this.view.hamburgerMenu.setCurrentPage('frmAfterHearing');
  ...
  onBreakpointChange: function(width){
    try{
    amplify.publish("secondaryBreakpointTrigger", width);
    ...
    this.view.blueSection.breakPointChange(width);
