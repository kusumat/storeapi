  ...
  return {
    constructor: function(baseConfig, layoutConfig, pspConfig) {
      ...
      this.view.flxVideoReverseHeadingContainer.accessibilityConfig = {
        ...
        "a11yHint": this.view.lblLoginTextTitle.text,
        "a11yARIA": {"role": "heading", "aria-level": "1"},
        "a11yIndex": 0,
        "a11yHidden": false
      };
      this.view.flxSMSHeadingContainer.accessibilityConfig = {
        "a11yLabel": this.view.lblSMSTitleText.text,
        "a11yHint": this.view.lblSMSTitleText.text,
        "a11yARIA": {"role": "heading", "aria-level": "1"},
        "a11yIndex": 0,
        "a11yHidden": false
      };
    ...
    breakPointChange:function(widthVal){
      if(widthVal >= 900 && widthVal <= 1024 ){
        ...
        this.view.flxSquare2.height = '355px';
        this.view.flxSquare2.width = '360px';
        ...
        this.view.flxSquare3.left = '';
        this.view.flxSquare3.right = '5%';
        this.view.flxSquare3.top = '-360px';
        this.view.flxSquare3.centerX = '';
        this.view.flxSquare3.height = '360px';
        this.view.flxSquare3.width = '355px';
        ...
        this.view.flxSquare2.width = '355px';
        this.view.flxContentSquare2.left = '';
        this.view.flxContentSquare2.right = '';
        this.view.flxContentSquare2.top = '0px';
        this.view.flxContentSquare2.bottom = '0px';
        this.view.flxContentSquare2.width = '360px';
        this.view.flxContentSquare2.height = '355px';
        this.view.flxContentSquare2.centerX = '50%';
        ...
        this.view.flxSquare3.left = '';
        this.view.flxSquare3.right = '0%';
        this.view.flxSquare3.top = '10px';
        this.view.flxSquare3.centerX = '';
        this.view.flxSquare3.height = '330px';
        this.view.flxSquare3.width = '100%';
        this.view.flxSquare3.bottom = '';
        this.view.flxContainerSMSPostIt.height = '330px';
        this.view.imgSMSPostitImage.height = '330';
