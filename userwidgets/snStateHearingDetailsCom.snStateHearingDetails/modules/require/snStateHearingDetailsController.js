      ...
      else 
      {
        ...
        {      
          if(response !== null && response !== undefined && 
            ...
            var vMimeType = response.mimeType;
            var selectedRow = this.view.sgmDocuments.selectedRowItems[0];
            ...
            if (documentType === "Hearing Recording" || documentType === "Virtual Hearing Recording") {
              var basicConf = {
                ...
                alertYesLabel: "Yes",
                alertNoLabel: "No",
                message: "Do you want to download the \"" + documentTitle + "\" file?",
                alertHandler: function (label) {
                  if (label) {
                    displayPDFWindow(documentData, documentType, documentTitle, this.win, vMimeType);
                 }
                }
              };
              var pspConfig = {
