...
//       this.view.radioReceivedNotice.onSelection = this.setReceivedNotice;
      ...
      this.view.TabPaneSearch.calendarCompliance.onTouchEnd = this.alignCalendarCompliance.bind(this);
      ...
      var CheckBoxObject = [["Include Received Status", "Include Received Status", accessibilityConfig={"a11yHidden": false, "a11yLabel": "", "a11yHint": "", "a11yIndex": 0}]];
      this.view.TabPaneSearch.CheckBoxReceivedStatus.masterData = CheckBoxObject;
    ...
    keyDown: function(e){ 
      if (window.event.code.includes("Alt")) {
        altKey = true;
      }
        ...
        if (window.event.code === "ArrowRight") {
          switch (this.view.TabPaneSearch.activeTab) {
            ...
            case 1:
              ...
              break;        
            case 2:
              this.view.TabPaneSearch.activeTab = 3;
              break;   
            case 3:
              this.view.TabPaneSearch.activeTab = 3;
              break; 
    ...
    setComponentData: function(contButton) {
      ...
      //this.view.TabPaneSearch.CheckBoxReceivedStatus.selectedKeys = null;
    ...
    alignCalendarCompliance: function() {
      //you can use: "right","left","top" or "bottom"
      try {
        this.view.TabPaneSearch.calendarCompliance.setContext({
          "widget": this.view.TabPaneSearch.calendarCompliance,
          "anchor": "bottom"
        });
      } catch (ex) {
    ...
    getComponentData: function(contButton) {
      ...
      gblARComplianceDate = "";
      if (this.view.TabPaneSearch.calendarCompliance.formattedDate !== ""){
        gblARComplianceDate = this.view.TabPaneSearch.calendarCompliance.formattedDate;
      }
      if(this.view.TabPaneSearch.CheckBoxReceivedStatus.selectedKeys !== null)
        gblARReceivedStatus = true; 
      else
        gblARReceivedStatus = false; 
    },
    ...
    onBreakpointChange: function(form, width){
      if(width <= gblBreakPoint) {
        ...
        this.view.TabPaneSearch.lblLastName.skin = 'sknLblGrayishDark115Mobile';
        this.view.TabPaneSearch.lblComplianceDate.skin = 'sknLblGrayishDark115Mobile';
        this.view.TabPaneSearch.lblIncludeReceivedStatus.skin = 'sknLblGrayishDark115Mobile';
        ...
        this.view.TabPaneSearch.lblLastName.skin = 'sknLblGrayishDark100';
        this.view.TabPaneSearch.lblComplianceDate.skin = 'sknLblGrayishDark100';
        this.view.TabPaneSearch.lblIncludeReceivedStatus.skin = 'sknLblGrayishDark100';
