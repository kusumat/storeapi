define(function() {
  ...
  return {
    ...
    setComponentData:function(appellant) {
      ...
      this.view.lblTextCompletedDate.text = appellant.completedDate;
      this.view.lblTextHearingDate.text = appellant.hearingDate;
      this.view.lblTextCaseNumber.text = appellant.caseNbr;
      this.view.lblTextAppealType.text = appellant.appealTypeDescription;
      this.view.lblTextProgram.text = appellant.portalProgramDesc;
      this.view.lblTextPortalIssue.text = appellant.portalIssueCode;
    },

    showDetails:function() {
      gblAppellantId = this.view.lblAppellantId.text;
      gblPortalStatus = this.view.lblTextPortalIssue.text;
      ...
      gblAppealTypeDescription = this.view.lblTextAppealType.text;
