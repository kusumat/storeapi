   ...
   */
    ...
    setSectionData:function(appealDetails, title, message) {
      ...
      for(var i = 0; i < segmentLength; i++) {
        ...
        var detailRow = {//"imgArrowRight":"arrow_left.png", 
                         "imgArrowRight":{'isVisible' : true},
        ...
        {      
          if(response !== null && response !== undefined) {
            if(response.AppealDetails !== null && response.AppealDetails !== undefined) {
              ...
              gblAppealDetailInfo.receivedDate =( details.bshReceiveDate !== "null" && details.bshReceiveDate !== null && details.bshReceiveDate !== undefined ) ? details.bshReceiveDate : gblNotAvailableDataLabel;
              gblAppealDetailInfo.noticeDate = (details.NoticeDate !== "null" && details.NoticeDate !== null && details.NoticeDate !== undefined) ? details.NoticeDate : "None";
              ...
              gblAppealDetailInfo.requestDate = (details.RequestDate !== "null" && details.RequestDate !== null && details.RequestDate !== undefined) ? details.RequestDate : gblNotAvailableDataLabel;
