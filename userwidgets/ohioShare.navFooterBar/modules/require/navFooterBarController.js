define(function() {
  ...
  return {
    ...
    openLinkUSDANDS: function () {
      kony.application.openURL("https://jfs.ohio.gov/help-center/food-assistance-non-discrimination-statement");
    },
    ...
    openLinkInfo: function () {
      kony.application.openURL("https://jfs.ohio.gov/help-center");
    },
    
    openLinkPrivacy: function () {
      kony.application.openURL("https://jfs.ohio.gov/help-center/privacy-statement/privacy-statement");
    },
