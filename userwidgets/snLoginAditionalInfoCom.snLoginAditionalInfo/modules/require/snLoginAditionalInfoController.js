...
define(function() {
  return {
    ...
    onBreakpointChange: function(form, width){
      try{
        if(gblRepresentingOption.startsWith("TPM")) {
        this.view.txtCompanyName.placeholder = "Enter Company Name";
      }
      else{
        this.view.txtCompanyName.placeholder = "Enter Company Name (Optional)";
      }
    ...
    validateUserInfo:function() {
      ...
      if(gblRepresentingOption.startsWith("AR") || gblRepresentingOption.startsWith("TPM")) {
        ...
        if(this.view.txtCompanyName.text.trim() === "" && gblRepresentingOption.startsWith("TPM")) {
          alert("Company name cannot be empty");
          this.view.txtCompanyName.setFocus(true);
          return false;
        }
