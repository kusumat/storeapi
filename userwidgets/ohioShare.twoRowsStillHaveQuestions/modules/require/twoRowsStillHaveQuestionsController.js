  ...
  return {
    ...
    breakPointChange:function(widthVal){
      if(widthVal < 1024 && widthVal >= 900 ){
        ...
        this.view.rchTxtBulletPointA.text = 'If you are unable to login to SHARE, <a style="color: #000000; font-size: 16px; cursor:pointer" href=" https://secure.jfs.ohio.gov/ols/RequestHearing/" target="_blank"><u>you can still request a State Hearing here</u> </a> or contact us at 866 635-3748.';
   ...
   //     this.view.lblBulletPoint2.skin = 'lblFont000000OpenSansRegular16px';
    ...
    //    this.view.rchTxtBulletPointB.text = '<a style="color: #000000; font-size: 16px; cursor:pointer" href=" https://secure.jfs.ohio.gov/ols/RequestHearing/" target="_blank">The Request a Hearing link from the ODJFS site.</a> <br><br>';
        ...
        this.view.rchTxtBulletPointA.text = 'If you are unable to login to SHARE, <a style="color: #000000; font-size: 24px; cursor:pointer" href=" https://secure.jfs.ohio.gov/ols/RequestHearing/" target="_blank"><u>you can still request a State Hearing here</u> </a> or contact us at 866 635-3748.';
