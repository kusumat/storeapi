  ...
  return {
    ...
    setWhatHappenedData: function() {
      ...
      while(!element.done) {
        ...
        if(gblBenefitsProgram === program && issueNumber === gblIssueNumber) {
          this.view.txtBoxComments.text = issueComments === undefined ? "" : issueComments;
          this.view.txtBoxComments.text =  removeSpecialCharacters(this.view.txtBoxComments.text);
